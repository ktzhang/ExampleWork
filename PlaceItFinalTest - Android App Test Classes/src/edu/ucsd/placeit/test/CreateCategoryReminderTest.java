...
public class CreateCategoryReminderTest extends UiAutomatorTestCase {
	
	public void testCreateReminder() throws UiObjectNotFoundException, RemoteException {
		...
		UiObject text = new UiObject(new UiSelector()
			.className("android.widget.EditText")
			.index(0));
...
//		catListButton.click();
//		
//		UiObject groceriesReminder = new UiObject(new UiSelector()
//			.className("android.widget.TextView")
//			.text("Get groceries"));
//		
//		//Verification newly created reminder
//		assertTrue("No category reminder created in database", groceriesReminder.exists());
//		
...
//		 *		Then: The user will be asked to select at least one location
//		 */
//						
//		newCatButton.clickAndWaitForNewWindow();
//		enterText.setText("Get cash");
//		text.click();
//		text.setText("There will be cash only vendors on the way, get enough cash");
//		subButton.clickAndWaitForNewWindow();
//		
//		UiObject noCategory = new UiObject(new UiSelector()
//			.className("android.widget.TextView")
//			.text("Please select at leaset one category."));
//		
...
//		catListButton.click();
//		
//		UiObject cashReminder = new UiObject(new UiSelector()
//			.className("android.widget.TextView")
//			.text("Get cash"));
//		
//		//Verification 3 category newly created reminder
//		assertTrue("No (3) category reminder created in database", cashReminder.exists());
//		
//		backButton.clickAndWaitForNewWindow();
